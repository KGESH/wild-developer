...
//   return (
//     <section className="flex items-center justify-center text-center h-full px-10">
//       <div className="max-w-3xl">
//         <h1 className="text-7xl font-semibold text-gray-100 mb-4">Hi, I&apos;m Wild Developer</h1> {/*I'm*/}
//         <h2 className="text-4xl font-semibold text-blue-500 mb-4">Full Stack Freelancer Digital Nomad</h2>
...
//         </p>
//         <div className="flex justify-between w-2/3 h-14 space-x-24 mx-auto">
//           <Link
//             href="#google-map"
//             className="flex justify-center items-center text-3xl text-gray-100 w-1/2 h-full border-2 rounded-lg bg-blue-500 border-blue-500 font-normal"
//           >
//             Where am I
//           </Link>
//           <Link
//             href="/contact"
//             className="flex justify-center items-center text-3xl text-blue-500 w-1/2 h-full border-2 rounded-lg border-blue-500 font-normal bg-transparent"
//           >
//             Contact
//           </Link>
//         </div>
